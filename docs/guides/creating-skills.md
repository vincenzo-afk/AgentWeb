...
- The current skill registry is an internal `/solve` orchestration surface. Public `/plan` and `/execute` agent endpoints and the learning loop remain deferred roadmap work.
